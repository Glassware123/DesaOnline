...
class RestClient {
     ...
     * @return RestClient
     */
    public static function delete($url,$params=null,$user=null,$pwd=null,$contentType="multipart/form-data") {
        return self::call("DELETE",$url,$params,$user,$pwd,$contentType);
    }
    /**
